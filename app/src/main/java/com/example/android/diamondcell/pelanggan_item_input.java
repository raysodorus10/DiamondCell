...
public class pelanggan_item_input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pelanggan_item_input);

        /*format tanggal dd-MM-yyyy menjadi seperti 01-12-2017*/
        dateFormatter = new SimpleDateFormat("dd-MM-yyyy", Locale.US);

        tvDateResult = findViewById(R.id.txtTanggalDaftar);
